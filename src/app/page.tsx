          ...
          <div className="container mx-auto px-4 relative z-20 text-center">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://discord.gg/GXZsHu3KQF" 
                 className="flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752c4] text-white px-6 py-3 rounded-lg font-medium transition shadow-md relative" 
              ...
              <a href="https://sbox.game/fss" 
                 className="flex items-center gap-2 bg-transparent border border-white hover:bg-white/10 text-white px-6 py-3 rounded-lg font-medium transition shadow-md" 
                 aria-label="Find us on S&Box"
                 target="_blank"
                 rel="noopener noreferrer">
                <svg width="24" height="16" viewBox="0 0 29 16" className="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <g>
