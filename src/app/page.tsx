        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="container mx-auto px-4 relative z-20 text-center">
            ...
            <div className="flex justify-center items-center gap-6 mt-8">
              ...
              <a href="https://sbox.game/fss" className="text-white hover:text-blue-400 transition" aria-label="S&Box">
                <svg width="29" height="16" viewBox="0 0 29 16" className="w-11 h-7" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <g>
