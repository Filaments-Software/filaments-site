...
const FilamentCard = lazy(() =>
  import("./_components/FilamentCard").then((mod) => ({
    default: mod.FilamentCard,
  })),
);
  ...
  const filaments = [
    {
      ...
      image: "/images/limina/limina.png",
      platforms: ["PC"],
    ...
    },
    {
      ...
      ident: "breach",
      title: "Breach",
      description: "A modern reimagining of GMOD's Breach.",
      image: "/images/breach/title.png",
      platforms: ["PC"],
      releaseStatus: "Halted",
    },
    {
      ...
      ident: "bloodsigil",
      title: "Bloodsigil",
      description: "A modern reimagining of GMODs Zombie Survival.",
      image: "/images/bloodsigil/Bloodsigil-bck-logo-square.png",
      platforms: ["PC"],
      ...
      <section className="relative flex h-screen flex-col overflow-hidden">
        <div className="absolute inset-0 z-0">
          <video
            ...
            playsInline
            preload="auto"
            className="video-background object-cover blur-[2px] filter"
            aria-hidden="true"
          >
        ...
        <div className="flex flex-grow items-start justify-center pt-40 md:pt-48 lg:pt-32">
          <div className="relative z-20 container mx-auto px-4 text-center">
            ...
            <p className="mb-4 text-lg font-semibold text-blue-300 md:text-xl">
              &quot;Don&apos;t copy; Iterate&quot;
            </p>
            ...
            <div className="flex justify-center gap-4">
              <a
                ...
                className="relative flex items-center gap-2 rounded-lg bg-[#5865F2] px-3 py-3 font-medium text-white shadow-md transition hover:bg-[#4752c4]"
      ...
      <section id="game-details" className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2">
            <Suspense
              fallback={
                <div className="flex min-h-[300px] items-center justify-center rounded-lg bg-white/5 backdrop-blur-sm">
